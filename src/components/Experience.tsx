  ...
  const experiences = [
    {
      ...
      achievements: [
        'Provide tier-1 & tier-2 IT support for 200+ staff across four offices',
        'Automated system-health checks, reducing incident response time by 25%',
        'Led SharePoint Online migration with zero data loss and minimal downtime',
    ...
    },
    {
      ...
      achievements: [
        'Maintained 80+ KEIMS kits with 99.9% uptime during election period',
        'Set up secure network infrastructure for polling stations',
        'Trained 100+ temporary clerks on electoral technology systems',
        'Developed real-time monitoring dashboard for voter turnout data'
      ],
      icon: Shield,
      color: 'accent-neon',
    ...
    },
    {
      ...
      achievements: [
        'Resolved tickets within SLA 95% of the time',
        'Updated Judiciary CMS weekly with 100% accuracy',
        'Documented network topology and created comprehensive SOPs',
        'Developed proof-of-concept e-filing portal reducing physical backlog by 60%'
      ],
      icon: Users,
      color: 'accent-purple',
    ...
    },
    {
      ...
      achievements: [
        'Built 6 responsive websites for local SMEs with modern frameworks',
        'Achieved Google Page-1 rankings for 3 client websites',
        'Integrated payment APIs, boosting client revenue by 40%',
        'Maintained 98/100 average Lighthouse performance scores'
      ],
      icon: TrendingUp,
      color: 'accent-pink',
    ...
    <section id="experience" className="py-20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              ...
              >
                ...
                <div className={`w-full md:w-5/12 ml-12 md:ml-0 ${isEven ? 'md:mr-auto md:pr-8' : 'md:ml-auto md:pl-8'}`}>
                  <div className={`glass rounded-2xl p-6 hover-lift animate-fade-in-up`} style={{ animationDelay: `${index * 0.2}s` }}>
                    {/* Header */}
                    <div className="mb-4">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        {exp.achievements.map((achievement, achIndex) => (
                          <li key={achIndex} className="flex items-start text-sm text-foreground-muted">
        ...
        <div className="mt-16 glass rounded-2xl p-8 text-center hover-lift">
          ...
          <h3 className="text-2xl font-semibold text-foreground mb-2">{ongoingWork.title}</h3>
