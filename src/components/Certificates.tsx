...
const Certificates = () => {
  ...
  return (
    <Section
      ...
      description="View and verify my academic and professional credentials. Previews render the original document, and downloads are password-protected."
      contentClassName="grid gap-8 md:grid-cols-2 xl:grid-cols-3"
    >
        ...
        >
          ...
          <div className="flex flex-col flex-1 p-8 space-y-5">
            ...
            <div className="mt-auto flex flex-col gap-3 sm:flex-row">
              ...
              <Button className="w-full sm:w-auto btn-electric" onClick={() => handleProtectedDownload(certificate)}>
