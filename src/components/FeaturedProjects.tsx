...
const FeaturedProjects = () => {
  return (
    <Section
      ...
      description="A curated selection of live deployments showcasing the breadth of my product thinking, interaction design, and full-stack engineering capabilities."
      contentClassName="grid gap-10 md:grid-cols-2 xl:grid-cols-3"
    >
