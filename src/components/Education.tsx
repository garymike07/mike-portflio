  ...
  const education = [
    {
      ...
      highlights: [
        'Graduated with honors in Software Engineering track',
        'Final year project: Network Management System for SMEs',
        'Active member of Computer Science Society',
        'Completed internship at Kenya Power & Lighting Company'
      ]
    },
    {
      degree: 'KCSE Grade B',
      ...
      highlights: [
        ...
        'Computer Studies: A (Top in class)',
        'Member of Science Club and Mathematics Society',
        'Represented school in inter-school programming competitions'
      ]
    },
    {
      degree: 'KCPE 345/500',
      ...
      highlights: [
        'Science: 85/100, Mathematics: 78/100',
        'English: 72/100, Kiswahili: 75/100',
        'School prefect and peer tutor',
        'Founded school computer club'
      ]
    }
  ];
                  ...
                  <div className="grid md:grid-cols-2 gap-2">
                    {edu.highlights.map((highlight, hIndex) => (
                      <div key={hIndex} className="flex items-start text-sm text-foreground-muted">
                        <Star size={12} className="text-accent-electric mt-1 mr-2 flex-shrink-0" />
                        {highlight}
                      </div>
                    ))}
                  </div>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        {cert.skills.length > 3 && (
                          <span className="px-2 py-1 bg-background-tertiary rounded text-xs text-foreground-muted">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {cert.skills.map((skill, skillIndex) => (
                          <span 
                            key={skillIndex}
                            className="px-3 py-1 bg-gradient-to-r from-primary/10 to-primary/5 border border-primary/20 rounded-full text-sm text-foreground"
                          >
                            {skill}
                          </span>
                        ))}
